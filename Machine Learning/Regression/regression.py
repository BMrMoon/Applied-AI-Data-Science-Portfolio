...
### Business Problem
## Using a dataset that contains the features and prices of individual houses, a machine learning project is intended to be carried out to predict the prices of different types of houses.


### Story of the Dataset
## This dataset, which consists of residential homes in Ames, Iowa, contains 79 explanatory variables. The project, which also has a competition on Kaggle, can be accessed through the dataset and competition page via the link below. Since the dataset belongs to a Kaggle competition, there are two separate CSV files: train and test. In the test dataset, house prices are left blank, and you are expected to predict these values.
